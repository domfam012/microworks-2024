					...
					<article class="bbs-list-con product-board-con">
						<div class="bbs-list-tbl">
							<p class="bbs-list-head">
								...
								<span style="width:68%;" class="board-head-title">제목</span>
								<!-- <span style="width:15.5%;">조회수</span>
...
<?
	...
	$query		= "select count(*) as total from $table";
		if($search_order){
			if($search_item){
				$query.=" where $search_item like '%$search_order%'";
			}else{
				$query.=" where (name like '%$search_order%' or phone like '%$search_order%' or content like '%$search_order%')";
			}
		}
